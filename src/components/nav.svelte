<script lang='ts'>
  ...
  <div in:fade={{duration: 500, delay: 100}} class='h-12 flex text-gray mx-8 text-center justify-center items-center'>
  ...
  <div class='hidden mr-10 gap-8 w-full md:flex justify-end items-center ' id='nav' >
    {#each data as item, index}
	  ...
	  {/each}
    <a in:fade={{duration: 500, delay: 800}} href="/#portafolio ">
