...
<div class=' flex flex-col items-center h-full '>
  <div class=' w-full md:w-2/3 lg:w-2/3  flex items-start justify-start text-left  px-10 absolute top-1/2  transform  -translate-y-1/2 fadeIn '>
    <div class='flex flex-col gap-4 '>
      <p   in:fly="{{x: -200, duration: 1200, delay: 1200}}"class="text-green-400 font-mono pl-1">Hi, my name is</p>
      <h1   in:fly="{{x: -200, duration: 1200, delay: 1500}}"class=' text-gray-light font-black text-4xl  md:text-5xl lg:text-7xl'>
        {title}.
      </h1>
      ...
      <div   in:fly="{{y:200, duration: 1200, delay: 2400}}" class='pt-4'>
